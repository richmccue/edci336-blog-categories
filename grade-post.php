...
<html>
 ...
 <body>
 <h1>EDCI 336 Blog Tracker - Post Note</h1>
...
#If no grade was assigned, display current grade (if any).
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<p>Note <input name='grade' id='grade' size='5' value='" . $row['grade'] . "' /> 3=Excellent, 2=OK, 1=Needs Work</p>";
    echo "<p>Additional Notes <input name='notes' size='100' value='" . $row['notes'] . "' /></p>";
